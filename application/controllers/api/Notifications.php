...
class Notifications extends MY_Controller {
    ...
    public function unread() { $uid=$this->current_user->user_id; $this->json_ok(['count'=>$this->Notification_model->count_unread($uid),'items'=>$this->Notification_model->get_recent($uid,5)]); }
