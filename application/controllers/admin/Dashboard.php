...
class Dashboard extends Admin_Controller {
    ...
    public function index() {
        $y=date('Y'); $m=date('n');
        $stats=['total_emp'=>$this->User_model->count_all(['status'=>'active']),
        ...
        $this->render('admin/dashboard/index',['title'=>'แดชบอร์ด | ระบบ HRM','page_title'=>'แดชบอร์ด',
            'stats'=>$stats,'salary_sum'=>$this->Salary_model->get_monthly_summary($y,$m),
            'pending_leaves'=>$this->Leave_model->get_requests(['status'=>'pending'],5),
