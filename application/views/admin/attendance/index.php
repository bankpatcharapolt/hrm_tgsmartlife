...
<div class="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-2">
  <span class="text-muted small">รายการทั้งหมด <strong><?=count($records)?></strong> รายการ</span>
  <div class="d-flex gap-2">
    <a href="<?=base_url('admin/attendance/shifts')?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-clock me-1"></i>จัดการกะ</a>
    <a href="<?=base_url('admin/attendance/manual')?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg me-1"></i>บันทึกด้วยตนเอง</a>
  </div>
</div>
  ...
  <div class="card-body p-0">
    <div class="table-responsive">
      <table class="table table-hover mb-0">
        <thead><tr><th>วันที่</th><th>พนักงาน</th><th>กะ</th><th>เข้างาน</th><th>ออกงาน</th><th>สถานะ</th><th>สาย</th><th>ลา (ชม.)</th><th>OT</th><th>จัดการ</th></tr></thead>
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <span class="badge" style="background:<?=$r->shift_color??'#6b7280'?>;font-size:.68rem"><?=$r->shift_name?></span>
            ...
            <td>
              ...
              <?php if(!empty($r->leave_type_name)):?><br><small class="text-info"><?=$r->leave_type_name?></small><?php endif;?>
            </td>
            <td class="<?=$r->late_minutes>0?'text-danger':''?> small"><?=$r->late_minutes>0?$r->late_minutes.' น.':'–'?></td>
            <td class="small">
            ...
            <td>
              <a href="<?=base_url('admin/attendance/edit/'.$r->id)?>" class="btn btn-outline-secondary btn-sm px-2 py-0" title="แก้ไข"><i class="bi bi-pencil"></i></a>
          ...
          <?php endforeach;else:?>
          <tr><td colspan="10" class="text-center text-muted py-5"><i class="bi bi-clock fs-1 d-block mb-2"></i>ไม่มีข้อมูลการเข้างาน</td></tr>
          <?php endif;?>
        </tbody>
      </table>
    </div>
