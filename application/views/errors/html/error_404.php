...
$message = isset($message) ? $message : 'ไม่พบหน้าที่คุณต้องการ';
?>
<!DOCTYPE html>
<html lang="th"><head><meta charset="UTF-8"><title>404</title>
...
.ico{font-size:4rem;}h1{color:#d97706;font-size:2.5rem;margin:.5rem 0;}p{color:#6b7280;}a{display:inline-block;margin-top:1rem;padding:.5rem 1.5rem;background:#1a56db;color:#fff;border-radius:8px;text-decoration:none;}</style>
</head><body>
<div class="box">
  <div class="ico">🔍</div>
  <h1>404</h1>
